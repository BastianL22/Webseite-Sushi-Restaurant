...
<body>
    ...
    <header>
        <a href="Gaestebuch_content.php">
            <img id="engl" src="../Images/Flag_of_Germany.svg" width="90" height="40" title="Englisch-Button">
        </a>
        <div>
        ...
        <nav>
            ...
            <ul>
                ...
                <li><a id="speisekarte" title="Speisekarte" href="../speisekarte_e.html">MENU</a></li>
                <li><a id="service" title="Service" href="../Opening_hours_Service_Options_Payment_methods.html">SERVICE</a></li>
                <li><a id="kontakt" class="kontaktseite" title=Kontakt href="../Contact.html">CONTACT</a></li>
                <li><a id="galerie" title"Galerie" href="../Gallery.html">GALLERY</a></li>
                <li><a id="rezensionen" title="Rezensionen" href="reviews.php">REVIEWS</a></li>
            </ul>
        </nav>
    </header>

	<div id="guestbook-entries">
	<h1>Our Guest Book entries:</h1>
	<?php
...
<footer>
            <div id="footer1">
                ...
                <p>
                    ...
                    Mo-Th 11:00 - 15:00 / 17:00 - 21:00
                </p>
            </div>
            <div id="footer2">
                <p>
                    <a id="datenschutz" href=../Privacy_policy.html>Privacy</a>
                </p>
                <p id="copyright">&#169; Sushi Go 2021</p>
                <p>
                    <a id="impressum" href=../Impressum_e.html>Imprint</a>
                </p>
            </div>
        </footer>
        <button id="back2top" type="button" >
