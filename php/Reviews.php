...
<head>
    ...
    <meta name="Reviews" content="Customer reviews">
    <title>Reviews</title>
...
<body id="reviews">
    ...
    <header>
        <a href="Kundenrezensionen.php" tabindex="1">
            <img id="engl" src="../Images/Flag_of_Germany.svg" width="96" height="46" title="German-Button">
        </a>
        <a href="../About_us.html" tabindex="2">
        ...
        <nav>
            ...
            <ul>
                <li><a id="home" title="Home" href="../About_us.html">HOME</a></li>
                <li><a id="speisekarte" title="speisekarte" href="../Speisekarte_e.html" tabindex="3">MENU</a></li>
                <li><a id="service" title="Service" href="../Opening hours_Service Options_Payment methods.html" tabindex="4">SERVICE</a></li>
                <li><a id="kontakt" title=Kontakt href="../Contact.html" tabindex="5">CONTACT</a></li>
                <li><a id="galerie" title=Galerie href="../Gallery.html" tabindex="6">GALLERY</a></li>
                <li><a id="rezensionen" class="reviews" title=Rezensionen href="Reviews.php" tabindex="7">REVIEWS</a></li>
            </ul>
        </nav>
    </header>
    ...
    <div id="container">
        ...
        <div id="widget">
            ...
            <!--Quellenangabe-->
            <p id="quelle">
                Source: <a href="https://www.google.com/search?q=google+reviews+sushi+go+bitburg&client=firefox-b-d&biw=1280&bih=647&ei=woevYbj-OISN9u8P1r2J4AU&ved=0ahUKEwi457iKitL0AhWEhv0HHdZeAlwQ4dUDCA4&uact=5&oq=google+reviews+sushi+go+bitburg&gs_lcp=&sclient=gws-wiz" tabindex="8" title="Link to Google Reviews"> Google Reviews</a>
            </p>
        </div>
        ...
        <h1>YOUR FEEDBACK</h1>
        <p id="bewertung">
            If <b>you</b> enjoyed our sushi, please take a minute and leave a comment on Google Reviews or Facebook. This would help new customers to get a better idea of our products and give us the chance to continously improve our services:
        </p>
        <a id="button1" href="https://accounts.google.com/signin/v2/identifier?continue=https%3A%2F%2Fsearch.google.com%2Flocal%2Fwritereview%3Fplaceid%3DChIJ91UH26_dv0cRoCjZNDff2pU&flowName=GlifWebSignIn&flowEntry=ServiceLogin" tabindex="9" title="Click here to get to the review section on Google.">Write a review on Google</a>
        <a id="button2" href="https://de-de.facebook.com/SushiGoBitburg/reviews/?ref=page_internal" tabindex="10" title="Click here to get to the review section on Facebook.">Write a review on Facebook</a>
        ...
        <div id="gästebuch">
			...
			<h1>GUESTBOOK</h1>
            <p>
                <b>You</b> don't have a Facebook or a Google account? No problem! Leave a short review in our guest book!.
            </p>
            <?php
            ...
            <div class="box">
                <p>Submit an entry into our guest book!</p>
                <form method="post" action="make_gaestebuch_e.php" id="for_guests">
                    <fieldset>
                        <label for="name">Name:</label>
                        <input type="text" id="name" name="name" value="" maxlength="40">
                        <label for="nachricht">Your comment:</label>
                        <textarea id="nachricht" name="nachricht" rows="5" cols="40"></textarea>
                        <input type="submit" name="submit" value="Submit">
                    </fieldset>
                </form>

                <h2><a href="Gaestebuch_content.php">Guest Book submissions</a></h2>
            </div>
        </div>
    </div>
    ...
    <footer>
        <div id="footer1">
            ...
            <p>
                ...
                Mon-Sat: 11 a.m. to 3 p.m. / 5 p.m. to 9 p.m.
            </p>
        </div>
        <div id="footer2">
            <p>
                <a id="datenschutz" href="../Privacy_Policy.html" tabindex="9">Privacy Policy</a>
            </p>
            <p id="copyright">&#169; Sushi Go 2022</p>
            <p>
                <a id="impressum" href="../Impressum_e.html" tabindex="10">Legal Disclosure</a>
            </p>
        </div>
    </footer>
</body>
